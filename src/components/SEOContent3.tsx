        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontFamily: "Urbanist, sans-serif", fontSize: 16, color: "#555", lineHeight: 1.8 }}>
            <p style={{ marginBottom: 16 }}>
              L&apos;<strong>entretien regulier</strong> d&apos;un <strong>rideau metallique</strong> est la meilleure assurance contre les pannes imprevues. Dans le 2e arrondissement, ou les commerces des Grands Boulevards, de la rue Reaumur et du passage des Panoramas ouvrent et ferment leurs grilles metalliques plusieurs fois par jour, l&apos;usure mecanique est acceleree. Un contrat de maintenance annuel avec DRM Paris 2 comprend deux visites preventives : graissage des coulisses et de l&apos;axe, verification de la tension des ressorts, controle electrique du moteur et du boitier de commande, inspection visuelle des lames et de la lame finale.
            </p>
            <p style={{ marginBottom: 16 }}>
